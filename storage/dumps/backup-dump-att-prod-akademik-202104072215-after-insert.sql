...
INSERT INTO `dosen` VALUES (1,'KUSRINI',NULL),(2,'ANDI SUNYOTO',NULL),(3,'HANIF AL FATTA',NULL),(4,'DIAH',NULL),(5,'EMA UTAMI',NULL);
...
INSERT INTO `kelas` VALUES (1,'P1',2),(2,'P1',3),(3,'B2',1),(4,'B2',2),(5,'B1',4);
...
INSERT INTO `krs` VALUES (1,1,4),(1,3,3),(2,1,2),(2,2,3),(3,1,NULL),(4,1,1);
...
INSERT INTO `mahasiswa` VALUES (2001,1,'ANITA','MAGELANG','1985-01-01 00:00:00'),(2001,2,'EKAWATI','YOGYA','1988-08-02 00:00:00'),(2002,3,'FARIDA','MADIUN',NULL),(2002,4,'GALIH',NULL,NULL);
...
INSERT INTO `matakuliah` VALUES ('B1','BAHASA INGGRIS',2),('B2','BASIS DATA',4),('P1','PEMROGRAMAN',2),('S2','SISTEM PAKAR',2),('S3','KALKULUS',NULL);
...
-- Dump completed on 2021-04-07 22:15:29
